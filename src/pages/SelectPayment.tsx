...
export default function SelectPayment({ onBack, onConfirm, price }: SelectPaymentProps) {
        ...
        <div className="space-y-4">
          {MOCK_PAYMENT_METHODS.map((method) => {
            ...
            return (
              ...
              >
                {/* Visual Glow para el seleccionado (opcional, extra high-tech) */}
