...
import { 
  ...
  Map as MapIcon, Layers, Compass, Crosshair 
} from 'lucide-react';
...
interface StaffNavigationProps {
  onBack: () => void;
  onArrived: () => void; // Acción al llegar
}
  ...
  return (
    <div className="relative h-screen w-full bg-[#0F1115] overflow-hidden font-sans text-white">
      ...
      <div className="absolute inset-0 z-0">
         {/* Imagen de mapa oscuro de alta calidad */}
         <img 
            src="https://images.unsplash.com/photo-1524661135-423995f22d0b?q=80&w=1000&auto=format&fit=crop" 
            alt="Dark Map" 
            className="w-full h-full object-cover opacity-60 mix-blend-normal grayscale-[20%] contrast-125"
         />
         <div className="absolute inset-0 bg-[#0F1115]/30"></div> {/* Overlay para oscurecer */}
         
         {/* SVG ROUTE OVERLAY (Simulación de Ruta) */}
         ...
         {/* ETA BUBBLE (Flotante en el mapa) */}
         ...
         {/* Navegador (Flecha de posición actual) */}
      ...
      <div className="absolute bottom-0 w-full bg-[#111318] rounded-t-[32px] p-6 pb-8 z-30 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] border-t border-white/10">
        ...
        <button 
           onClick={() => {
               ...
               // Simular llegada tras un momento o inmediatamente para la demo
