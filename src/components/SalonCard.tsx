...
export const SalonCard = ({ name, address, rating, image, tags }: SalonCardProps) => {
  return (
    <div className="bg-white p-3 rounded-2xl shadow-sm border border-slate-100 flex gap-4 mb-3 items-center">
